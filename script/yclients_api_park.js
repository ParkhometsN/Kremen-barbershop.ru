...
var yWidget = {
    currentDomain: 'yclients.com',
        ...
        sdkSource: 'https://n472970.yclients.com' + '/js-sdk/sdk.min.js',
        analyticUdidStoreKey: "analytics-udid",

        showNewWidgetAutomatically: false,
        initialized: false,
		id: '472970',
		href: 'https://b472970.yclients.com/',
        script_href: 'https://w472970.yclients.com',
		lang: 'rus',
		isNew: '1',
...
trackButtonView: function() {
    ...
    yWidget.setConfing();
    yWidget.addCSS();
    yWidget.click = yWidget.clickevent(); // Оставьте это, если вам нужно назначить обработчик кликов на другие кнопки
    yWidget.initCounters();

    // Найдите кнопку с ID active_button
    var activeButton = document.getElementById('active_button');
    if (activeButton) {
        ...
        activeButton.addEventListener('click', function(e) {
            ...
            var url = yWidget.href; // Укажите URL общего выбора филиалов
            yWidget.show(url); // Показать виджет с указанным URL
        });
    }
    ...
    trackPageView: function() {
      ...
      loadSuperButton: function() {
        ...
        window.yClientsWidgetOptions = {
            target: outlet,
            widgetBaseUrl: 'https://n472970.yclients.com',
            companyId: '222373',
            widgetId: '472970',
        ...
        script.setAttribute('src', 'https://n472970.yclients.com/superbutton/superbutton.umd.min.js');
