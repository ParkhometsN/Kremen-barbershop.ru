...
async function getStaffData() {
    ...
    const url = 'https://b472970.yclients.com/company/222373/personal/select-master?o=m3490159';
    ...
    fs.writeFileSync('staff_data_park.json', JSON.stringify(staffData, null, 4), 'utf-8');
